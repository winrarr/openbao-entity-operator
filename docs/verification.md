...
| `make test` | Client HTTP behavior, Kubernetes Auth login/renew/re-login, policy lifecycle, and identity reconciliation transitions pass unit tests | Does not exercise a live Kubernetes API server or OpenBao |
