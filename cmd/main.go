...
import (
	...
	openbaocontroller "github.com/rkthtrifork/openbao-entity-operator/internal/controller/openbao"
...
func main() {
	...
	cacheOptions, err := openbaocontroller.CacheOptionsForWatchNamespaces(watchNamespaces)
	if err != nil {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "9b9ccd24.openbao-operator.io",
